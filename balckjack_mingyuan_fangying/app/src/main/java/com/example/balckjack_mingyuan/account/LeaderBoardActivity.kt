package com.example.balckjack_mingyuan.account
...
import com.example.balckjack_mingyuan.game.Player
import com.example.balckjack_mingyuan.game.PlayerAdapter
...
class LeaderBoardActivity : AppCompatActivity() {
    ...
    private fun loadPlayers() {
        ...
        db.collection("Player")
                .orderBy("winTimes", Query.Direction.DESCENDING)
